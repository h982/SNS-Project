...
public class EmailController {
	...
	public ResponseEntity<Map<String, Object>> sendEmail(@RequestParam(name = "member_email") String memberEmail) throws MessagingException {
		...
		emailcontent.append("</body>");
		emailcontent.append("</html>");
		emailService.sendMail("admin", memberEmail + " <" + memberEmail + ">", "혼자 머하니 이메일 인증", emailcontent.toString());
	...
	public ResponseEntity<Map<String, Object>> checkEmail(@RequestParam(name = "num") int num) throws MessagingException {
		Map<String, Object> resultMap = new HashMap<>();
    	HttpStatus status = null;
