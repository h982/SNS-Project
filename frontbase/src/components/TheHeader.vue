  ...
  <div>
    ...
    >
      ...
      <v-list class="pt-4" v-else>
        ...
        <v-list-tile active-class="green--text" to="/teammain">
          <v-list-tile-content>
            <v-list-tile-title>임시선택된팀</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
      ...
      <!-- <v-list class="pt-4">
        ...
        <v-list-tile active-class="green--text" to="/group">
          <v-list-tile-content>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-items class="hidden-sm-and-down" v-else>
        ...
        <v-btn flat to="/myteam" active-class="green--text headline"
          >MyTeam</v-btn
        >
        <v-btn flat to="/teammain" active-class="green--text headline"
          >임시 선택된팀</v-btn
        >
